...
var scale1 = ['Very unpleasant', '', '', '', '', '', 'Very pleasant']
...
main.blocks.controlTrials = {
  ...
  timeline: [
    ...
    {
      type: 'survey-text',
      questions: [{prompt:"<p>The screen will automatically go to the next page after <b>15 seconds.</b> </p>"}],
      preamble: "<p>Please write the answer of the previously shown anagram here. Leave it blank if you don't know the answer. </p>",
      trial_duration: main.paramters.ViewTime
    },
    {
      type: 'survey-likert',
      questions: [{prompt: 'Please rate your pleasantness rating on a scale of 1-7 after you tried to solve the last anagram ', labels: scale1, required: true}]
    },
    {
...
main.blocks.surveyData = {
  ...
  timeline_variables: [
    {
      question: 'Did you solve the previous anagram shown to you?',
      extremes: ['No', 'Yes'], 
      requireds: true
    },
    {
      question: 'Please rate your pleasantness rating on a scale of 1-7 after you tried to solve the last anagram ',
