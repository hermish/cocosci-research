...
literals.instructionsTwo = [
	...
	'the answers for five of these questions, which five would they be?\n',

	'Please select exactly *five* questions to see answers for, otherwise the page will not let you submit. Please ' + 
...
literals.choosePage = [
	...
	'_Please remember to select exactly **five** questions you would like to see the answers to._'
].join('\n');
